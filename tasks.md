...
- [x] Geometry helpers for clamping, distance/projection, segment proximity, centroid, and bounds math (§4, §8, §12)
- [x] RectangleRegion: hit-test, corner/edge handles, aspect-lock resize, translation (§6.1, §12)
- [x] PolygonRegion: closed hit-test, vertex handles, translation, insert-vertex support (§6.1, §12)
- [x] PolylineRegion: segment proximity hit-test, vertex handles, translation (§6.1, §12)
- [x] LineRegion: two-point editing and stroke-band hit-testing with decorations-only direction model (§6.1, §6.3, §12)
- [x] EllipseRegion: bounding-box editing, edge/corner handles, translation, ellipse hit-testing (§6.1, §12)
- [x] Built-in decorations: direction indicator toggle and label decoration data model (§6.3, §12)
- [x] Cell grid abstraction and selection helpers with drag-paint semantics tests (§6.4, §12)
- [x] Built-in factories and DTO mappers for shipped regions/decorations (§11, §15)
